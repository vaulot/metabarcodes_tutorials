...
This tutorial explain how to process Illumina sequences using mothur.  The first part of the tutorial makes use of R to obtain information on the number and quality of sequences.
...
(@) **The final result in a single file with all the information**
