...
```{r}
  ...
  # Only consider files containing the R1 extension 
   # the R2 file should have the same number of sequences
...
#  write.table(df, file = paste0(working_dir,"/n_seq.txt"), sep="\t", 
...
* mothur_carbom_linux.sh : use on a server (not tested on Mac)
