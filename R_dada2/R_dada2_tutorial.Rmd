...
### Create names for the filtered files in ../fastq_filtered/
```{r}
  filt_R1 <- file.path(filtered_dir, paste0(sample.names, "_R1_filt.fastq"))
  filt_R2 <- file.path(filtered_dir, paste0(sample.names, "_R2_filt.fastq"))
```  
...
```{r}
  ...
  # Create a database like file for dada2
    ...
    write_tsv(dada2_database, str_c(dada2_dir, "CARBOM_dada2.database.tsv"))

```

### Write FASTA file for BLAST analysis
