...
* **/databases** : PR2 database files (see Prerequisite belwo)
...
### Construct a list of the fastq files and extract the sample names (start of file name separated by _)
...
```{r}
    pr2_file <- paste0(tutorial_dir, 
                       "metabarcodes_tutorials/databases/pr2_version_4.72_dada2_Eukaryota.fasta.gz")
...
```{r}
    write.table(taxa$tax, file = paste0(working_dir,"/taxa.txt"), sep="\t", 
                row.names = TRUE, na="", quote=FALSE, append=FALSE)   
    write.table(taxa$boot, file = paste0(working_dir,"/taxa_boot.txt"), sep="\t", 
                row.names = TRUE, na="", quote=FALSE, append=FALSE) 
    write.table(seqtab.nochim, file = paste0(working_dir,"/seqtab.txt"), sep="\t", 
                row.names = TRUE, na="", quote=FALSE, append=FALSE) 
```
